...
with(epc_2, 
     plot(Date_Time,Sub_metering_1, ylab="Energy sub metering", xlab = "",cex = 0, type="o", col = "black",
          ylim=c(0,40))
)
par(new=TRUE)
with(epc_2, 
     plot(Date_Time,Sub_metering_2, ylab="Energy sub metering", xlab = "",cex = 0, type="o", col = "red",
          ylim=c(0,40))
)
par(new=TRUE)
with(epc_2, 
     plot(Date_Time,Sub_metering_3, ylab="Energy sub metering", xlab = "",cex = 0, type="o", col = "blue",
          ylim=c(0,40))
)
